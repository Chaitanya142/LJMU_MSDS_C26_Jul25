...
8.  Full evaluation metrics report
"""
...
def main():
    ...
    # ── 2. Train ensemble ────────────────────────────────────────────────────────────
    print("[7/8] Training XGBoost + Random Forest + LightGBM fund-scoring ensemble ...")
    ...
    try:
        ...
        print(f"      Ensemble trained {hist_flag}  —  "
              f"RF R²={ensemble_metrics.get('rf_r2', 0):.4f}  "
              f"XGB R²={ensemble_metrics.get('xgb_r2', 0):.4f}")
    ...
    if not args.skip_eval:
        print("[8/8] Running all evaluation metrics ...")
